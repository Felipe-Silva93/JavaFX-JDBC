...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
		    ...
		    Scene mainScene = new Scene(scrollPane);//cria um objeto do tipo scine que sera  a cena principal estancia a cena passando como argumento o objeto principal da view que é o anchorpane vazio
